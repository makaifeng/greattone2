...
public class PutObjectSamples {
    ...
    // 从本地文件上传，使用非阻塞的异步接口
    public void asyncPutObjectFromLocalFile(final UpdateListener updateFileListener) {
        // 构造上传请求
        PutObjectRequest put = new PutObjectRequest(testBucket, testObject, uploadFilePath);
        ...
        put.setProgressCallback(new OSSProgressCallback<PutObjectRequest>() {
            ...
            public void onProgress(PutObjectRequest request, long currentSize, long totalSize) {
            	updateFileListener.onProgress(request, currentSize, totalSize);
        ...
        oss.asyncPutObject(put, new OSSCompletedCallback<PutObjectRequest, PutObjectResult>() {
            ...
            public void onSuccess(PutObjectRequest request, PutObjectResult result) {
            	updateFileListener.onSuccess(request, result);
                Log.d("PutObject", "UploadSuccess");
            ...
            public void onFailure(PutObjectRequest request, ClientException clientExcepion, ServiceException serviceException) {
            	updateFileListener.onFailure(request, clientExcepion, serviceException);
                // 请求异常
    ...
    public void asyncPutObjectWithServerCallback() {
        ...
        put.setCallbackParam(new HashMap<String, String>() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -8709034884992198657L;

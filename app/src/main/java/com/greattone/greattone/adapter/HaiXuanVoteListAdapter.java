...
public class HaiXuanVoteListAdapter extends BaseAdapter {
	...
	public HaiXuanVoteListAdapter(Context context, List<ActivityVideo> activitiesList) {
	...
	class ViewHolder {
		...
		public void setPosition(int position) {
			...
			name.setText(activitiesList.get(position).getHai_name());
			title.setText(activitiesList.get(position).getHai_petition());

...
public class CelebrityPostsListAdapter extends BaseAdapter {
	...
	private int type;
	public CelebrityPostsListAdapter(Context context, List<Blog> blogsList, List<ImageData> imageUrlList, int type) {
...
//				title.setText(blogsList.get(position).getHai_name() +context.getResources().getString(R.string.的报名));
			...
			if (blogsList.get(position).getClassname().equals("视频")) {// 视频
				...
				title.setText(blogsList.get(position).getTitle()+"-音乐");

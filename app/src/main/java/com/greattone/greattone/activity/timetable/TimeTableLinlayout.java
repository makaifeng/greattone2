...
public class TimeTableLinlayout extends LinearLayout {
	...
	private TextView monthView,lastMonthView,nextMonthView;
	...
	private void createYearAndMonthLayout() {
		...
		RelativeLayout.LayoutParams monthParams = new RelativeLayout.LayoutParams(LayoutParams.WRAP_CONTENT,
				LayoutParams.WRAP_CONTENT);
		monthParams.addRule(	RelativeLayout.CENTER_IN_PARENT);
		monthView.setLayoutParams(monthParams);
		monthView.setPadding(0, dip2px(10), 0, dip2px(10));
 ...
 */
	private void createButtonForNextMonth(RelativeLayout relativeLayout) {
		 	lastMonthView = new TextView(getContext());
		RelativeLayout.LayoutParams monthParams = new RelativeLayout.LayoutParams(LayoutParams.WRAP_CONTENT,
				LayoutParams.WRAP_CONTENT);
		monthParams.addRule(	RelativeLayout.ALIGN_PARENT_LEFT);
		lastMonthView.setLayoutParams(monthParams);
		lastMonthView.setPadding(dip2px(5), dip2px(5), dip2px(5), dip2px(5));
		lastMonthView.setGravity(Gravity.CENTER);
		lastMonthView.setBackgroundColor(Color.rgb(254, 215, 88));
		lastMonthView.setText("上个月");
		lastMonthView.setOnClickListener(new OnClickListener() {
		...
		relativeLayout.addView(lastMonthView);
	}
/**
 *下个月按钮
 * @param relativeLayout
 */
	private void createButtonForLastMonth(RelativeLayout relativeLayout) {
		...
		RelativeLayout.LayoutParams monthParams = new RelativeLayout.LayoutParams(LayoutParams.WRAP_CONTENT,
				LayoutParams.WRAP_CONTENT);
		monthParams.addRule(	RelativeLayout.ALIGN_PARENT_RIGHT);
		monthParams.bottomMargin=dip2px(5);
		nextMonthView.setLayoutParams(monthParams);
		nextMonthView.setPadding(dip2px(5), dip2px(5), dip2px(5), dip2px(5));
		nextMonthView.setGravity(Gravity.CENTER);
		nextMonthView.setBackgroundColor(Color.rgb(254, 215, 88));
		nextMonthView.setText("下个月");
		...
		relativeLayout.addView(nextMonthView);
	}
	...
	private void createWeekLayout() {
		...
		layout.setBackgroundColor(Color.rgb(254, 215, 88));
	...
	private void createDateLayout() {
		...
		flipper.setBackgroundColor(Color.rgb(254, 215, 88));
	...
	private void setGridViewAdapter() {
		adapter = new TimeTableAdapter(getContext(), getResources(), jumpMonth,

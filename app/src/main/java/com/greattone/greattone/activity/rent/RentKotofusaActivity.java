...
import com.greattone.greattone.adapter.RentKotofusaAdapter;
...
/*** 琴房租赁 */
public class RentKotofusaActivity extends BaseActivity {
...
/**获取发布的课程*/
	...
	protected void initContentAdapter() {
		...
		RentKotofusaAdapter adapter = new  RentKotofusaAdapter(
				context, courseList);

...
/** 全部学员列表 */
public class ClassRoomStudentActivity extends BaseActivity {
	...
	private void getStudent() {
		...
		HttpProxyUtil.getStudent(context,getIntent().getStringExtra("id"), new ResponseListener() {

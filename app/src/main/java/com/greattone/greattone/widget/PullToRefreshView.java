...
public class PullToRefreshView extends LinearLayout {
	 ...
	 * 是否禁止下拉
	 */
	private boolean refreshDown = false;
	/**
	 * 是否禁止上拉
	 */
	...
	/**
	 * init AdapterView like ListView,GridView and so on;or init ScrollView 初始化
	 * adapterview像ListView，GridView等；或init ScrollView
	 * 
	...
	public boolean onInterceptTouchEvent(MotionEvent e) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			if (!refreshDown && deltaY > 0) {
				return false;
			}
			if (!refreshUp && deltaY < 0) {
				return false;
			}
	...
	/**
	 * Resets the list to a normal state after a refresh. 重置列表到正常状态后刷新。
	 * 
	 * @param lastUpdated
	 *            Last updated at.
	 */
	...
	/**
	 * Set a text to represent when the list was last updated. 设置为上次更新列表时所表示的文本。
	 * 
	 * @param lastUpdated
	 *            Last updated at.
	 */
	 ...
	 * 设置能否下拉
	 */
	public void setHeaderRefreshDown(Boolean refreshDown) {
		this.refreshDown = refreshDown;
	}
	/**
	 * 设置能否上拉
	 */
	public void setFooterRefresh(Boolean refreshUp) {

...
public class HttpProxyUtil {
     ...
     * 访问网络
     */
    public static void addRequest(Context context,   HashMap<String, String> map, ResponseListener responseListener,
     ...
     * 发布商城的产品
     */
    public static void postProduct(Context context, HashMap<String, String> map, ResponseListener responseListener,
                                   ErrorResponseListener errorResponseListener) {
        if (map != null) {
                map.put("api", "mall/postMallProduct");
    //        map.put("title", title); //产品标题
    //        map.put("subtitle", subtitle);//产品副标题
    //        map.put("type", type);// 产品类型
    //        map.put("model", model);///产品型号
    //        map.put("titlepic", titlepic);  //产品多图
     ...
     *获取商城产品详情
     */
    public static void getProduct(Context context,String id, ResponseListener responseListener,
                                   ErrorResponseListener errorResponseListener) {
        HashMap<String, String> map = new HashMap<>();
        map.put("api", "mall/getProductDetail");
        map.put("id", id);
        addRequest(context,map,responseListener,errorResponseListener);
    }
    /**
     *商城订单生成
     */
    public static void creatMallOrder(Context context, HashMap<String, String> map, ResponseListener responseListener,
                                      ErrorResponseListener errorResponseListener) {
        if (map != null) {
